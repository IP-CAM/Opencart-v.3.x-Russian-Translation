...
// Text
$_['text_success']     = 'Успех: You have modified user groups!';
...
// Error
$_['error_permission'] = 'Внимание: You do not have permission to modify user groups!';
$_['error_name']       = 'User Group Name must be between 3 and 64 characters!';
$_['error_user']       = 'Внимание: This user group cannot be deleted as it is currently assigned to %s users!';